...
var imposter, imposter2, imposter3;
var tb1,tb2,tb3,tb4;
...
function preload(){
    ...
    defeat = loadImage("Images/defeat.png");
}
...
//PLAY 3:
if(gameState=="play3"){
        arrow4 = createSprite(800,400,20,20);
...
if(gameState=="end"){
   var end = createSprite(700,400,1400,800);
   end.addImage(victory);
   end.scale=3;
}

if(gameState=="end0"){
    var end0 = createSprite(700,400,1400,800);
